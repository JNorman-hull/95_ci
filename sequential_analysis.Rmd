...
- Fisher's Exact test (one.sided inferiority)
 ...
 - Sequential testing procedure when using one-sided fisher's exact. What are the lowest possible sample sizes, and create a stopping decision critieria  like the mortality table Account for alpha spend, data peeking? Not sure.
